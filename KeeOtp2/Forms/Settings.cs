...
namespace KeeOtp2
{
    public partial class Settings : Form
    {
        ...
        public Settings(IPluginHost host)
        {
            ...
            string toolTipMigration = "Since KeePass 2.47, OTPs can generated by a built-in\nfunction.This makes it obsolete to keep your OTP keys\nsaved in KeeOtp(1) format.It is also recommended!";
            ...
            string toolTipHotKeySequence = "Click inside the box to change the sequence!";
            ...
            string toolTipHotKeyCombination = "Click inside the box to change tho combination!";
        ...
        private void Settings_Load(object sender, EventArgs e)
        {
            ...
            labelMigrationStatus.Text = "(*Hover for more information)";
            labelMigrationStatus.Visible = true;
            labelMigrationStatus.Enabled = true;
        ...
        private void timerClock_Tick(object sender, EventArgs e)
        {
            ...
            labelTime.Text = String.Format("Preview (Utc): {0}", dateTime.ToLongTimeString());
        }
